...
define('views/trocarsenha',['app'], function (app) {
    var TrocarSenha = Backbone.View.extend({
        el: '.trocarsenha-ph',
        initialize: function () {
            app.master.activeTabView = this;
...
require(['views/trocarsenha'], function (TrocarSenha) {
    var view = new TrocarSenha();
});
define("Scripts/app/views/trocarsenha-main", function(){});
